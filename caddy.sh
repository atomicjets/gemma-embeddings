...
if ! command -v caddy >/dev/null 2>&1; then
  ...
  echo "[+] Unpacking and installing Caddy"
...
nohup /usr/local/bin/caddy run --config /tmp/Caddyfile --adapter caddyfile >/var/log/caddy.log 2>&1 &
sleep 2
