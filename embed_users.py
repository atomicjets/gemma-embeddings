    ...
    async def worker(session):
        ...
        while True:
            ...
            for doc in batch_docs:
                text = doc.get('text')
                if text:
                    valid_docs.append({'_id': doc['_id'], 'text': text})
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Generate user embeddings from a file.")
    ...
    parser.add_argument("--tmp-dir", type=str, default="/mnt/raid1/embeddings/users-tmp", help="Temporary directory for Parquet files.")
    parser.add_argument("--final-dir", type=str, default="/mnt/sdb_mount_point/embeddings/users-shards", help="Final directory for Parquet files.")
    parser.add_argument("--progress-dir", type=str, default="/mnt/raid1/embeddings/users-progress", help="Directory to store progress markers.")
